...
## 👋 About Me
I am a Computer Science (Data Science) graduate with a strong focus on data analysis, visualization, and problem-solving using real-world data. I enjoy working with structured datasets to extract insights, build dashboards, and support data-driven decision-making.

My primary strengths lie in analytical thinking, clean data preparation, and presenting insights clearly for both technical and non-technical audiences. My detailed projects and practical work can be found in the repositories below.

## 🌟 Skills
- **Programming**: Python, MySQL, Advanced Excel
